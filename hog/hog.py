...
def swine_align(player_score, opponent_score):
    ...
    if player_score * opponent_score == 0:
        return False
    divider = max(player_score, opponent_score)
    divident = min(player_score, opponent_score)
    while divident >= 10:
        divider, divident = divident, divider % divident
        if divident == 0:
            return True
    return False
    # END PROBLEM 4a
...
def pig_pass(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 4b
    return opponent_score - player_score in range(1, 3)
    # END PROBLEM 4b
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while max(score0, score1) < goal:
        if who == 0:
            strat, player_score, opponent_score = strategy0, score0, score1
        else:
            strat, player_score, opponent_score = strategy1, score1, score0
        player_score += take_turn(strat(player_score, opponent_score), opponent_score, dice)
        if who == 0:
            score0 = player_score
        else:
            score1 = player_score
        who = 1 - who
        if swine_align(player_score, opponent_score) or pig_pass(player_score, opponent_score):
            who = 1 - who
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    # BEGIN PROBLEM 7
    def high(score0, score1, last_score=last_score, running_high=running_high):
        if who == 0:
            if score0 - last_score > running_high:
                running_high = score0 - last_score
                print(str(running_high) + " point(s)! The most yet for Player " + str(who))
            last_score = score0
        else:
            if score1 - last_score > running_high:
                ...
                print(str(running_high) + " point(s)! The most yet for Player " + str(who))
            last_score = score1
        return announce_highest(who, last_score=last_score, running_high=running_high)
    return high
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    res = 0
    for i in range(1, 11):
        if make_averaged(roll_dice)(i, dice) > max_val:
            res = i
            max_val = make_averaged(roll_dice)(i, dice)
    return res
    # END PROBLEM 9
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    curr = score + free_bacon(opponent_score)
    if swine_align(curr, opponent_score) or pig_pass(curr, opponent_score):
        return 0
